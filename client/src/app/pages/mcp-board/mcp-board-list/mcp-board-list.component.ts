...
@Component({
  selector: 'app-mcp-board-list',
  templateUrl: './mcp-board-list.component.html',
  styleUrls: ['./mcp-board-list.component.css'],
})
export class MCPBoardListComponent implements OnInit {
  list: MCPBoard[];
